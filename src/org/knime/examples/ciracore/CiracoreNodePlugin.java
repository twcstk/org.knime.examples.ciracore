 ...
 * @author dv
 */
public class CiracoreNodePlugin extends Plugin {
    // The shared instance.
    private static CiracoreNodePlugin plugin;

    /**
     * The constructor.
     */
    public CiracoreNodePlugin() {
        super();
        plugin = this;
    }
     ...
     */
    public static CiracoreNodePlugin getDefault() {
        return plugin;
    }
